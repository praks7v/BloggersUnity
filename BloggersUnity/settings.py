...
SECRET_KEY = 'django-insecure-ij7rq-ji^xkq4oy@96m+e0&w&thkf-q$%6_j0z9c$)pnl&84%x'
...
# Custom Authentication backend for login through both email and username
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, "Tech", "static")
]
