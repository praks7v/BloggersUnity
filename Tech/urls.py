...
urlpatterns = [
    ...
    path(
        "blog/<int:blog_post_id>/edit",
        views.EditBlogPostView.as_view(),
        name="edit_blog_post",
    ),
    path(
        "blog/<int:blog_post_id>/delete",
        views.DeleteBlogPostView.as_view(),
    ...
    path(
        "author-posts/<str:author_name>/",
        views.AuthorPostView.as_view(),
        name="author_posts",
    ),
    # Urls for Categories
    path("category/", views.CategoryView.as_view(), name="all_categories"),
    path(
        "category/<str:category>/", views.CategoryView.as_view(), name="category_posts"
    ),
